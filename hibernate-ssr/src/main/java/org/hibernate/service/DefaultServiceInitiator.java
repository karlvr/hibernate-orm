...
/**
 * Contract for an initiator of services that target the {@link DefaultServiceRegistryImpl}.
 *
 * @param <R> The type of the service initiated.
 * 
 * @author Karl von Randow
 */
public interface DefaultServiceInitiator<R extends Service> extends ServiceInitiator<R> {
